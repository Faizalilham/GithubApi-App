...
import com.example.githubapi.databinding.ListItemBinding
import com.example.githubapi.model.UserGithub
import com.squareup.picasso.Picasso

class UserGithubAdapter(val listener : Clicked):RecyclerView.Adapter<UserGithubAdapter.UserGithubViewHolder>() {

    val diffUtil = object : DiffUtil.ItemCallback<UserGithub>(){
